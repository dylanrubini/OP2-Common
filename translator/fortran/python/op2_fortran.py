...
import op2_gen_cuda_color2
from op2_gen_cuda_color2 import *
...
#OpenMP
op2_gen_openmp3(str(sys.argv[init_ctr]), date, consts, kernels, hydra, bookleaf, utblock)  # optimised by removing the overhead due to fortran c to f pointer setups
...
op2_gen_cuda_color2(str(sys.argv[init_ctr]), date, consts, kernels, hydra,bookleaf, utblock) # does global coloring
