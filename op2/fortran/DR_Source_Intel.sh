...
#External libraries
export PARMETIS_INSTALL_PATH=/opt/parmetis4_Intel/
export PTSCOTCH_INSTALL_PATH=/opt/ptscotch6_Intel/
#export HDF5_INSTALL_PATH=/opt/hdf5-intel/
#export HDF5_INSTALL_PATH=/home/mudalige/hdf5-1.10.1-intel
export HDF5_INSTALL_PATH=/opt/hdf5_Intel/
#export LD_LIBRARY_PATH=/opt/parmetis-intel/lib:/opt/ptscotch-intel/lib:/home/mudalige/hdf5-1.10.1-intel/lib/:$LD_LIBRARY_PATH
export LD_LIBRARY_PATH=/opt/parmetis4_Intel/lib:/opt/ptscotch6_Intel/lib:/opt/hdf5_Intel/lib:$LD_LIBRARY_PATH
